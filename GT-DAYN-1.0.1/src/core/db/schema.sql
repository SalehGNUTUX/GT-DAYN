...
INSERT OR IGNORE INTO settings VALUES ('currency_sym', 'درهم');
INSERT OR IGNORE INTO settings VALUES ('lang',         'ar');
INSERT OR IGNORE INTO settings VALUES ('theme',        'auto');
...
CREATE TABLE IF NOT EXISTS debts (
  ...
  currency    TEXT    NOT NULL DEFAULT 'MAD',  -- عملة الدين (MAD, SAR, USD, ...)
  note        TEXT,
